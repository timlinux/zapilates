---
title: "The Method"
description: "What the Pilates method is, and why it works — the principles behind Joseph Pilates' method of exercise for body integrity."
image: "/images/3CirclesImagePilates.png"
weight: 10
---
...
The Pilates method of exercise is taught by many people in many different ways and with various approaches. The method was designed by **Joseph Pilates** in the early 1900s. He was a visionary in his advanced approach towards health and fitness, and many of his beliefs are considered vital to our modern understanding of physical health.
...
This is achieved through the application of certain principles that underlie the method.

**Mind-body.** One of the most beneficial principles is the *mind-body* aspect, which requires a conscious effort — concentration — to be applied to all the exercises. This ensures that an understanding of the body is developed, and therefore that the "integrity" being built is something that will exist beyond the studio.

**A strong centre.** Pilates strives to create a body that works without undue tension. Tension is often the root cause of injury, and incorrect or imbalanced muscle usage is often the cause of tension. It follows that a body able to work without undue tension is less likely to be injured and is also likely to work more effectively. This requires concentration and understanding (mind-body communication), creating a *strong centre* — a **girdle of strength** — by engaging *transversus abdominis* especially. Correct body alignment (e.g. maintaining a neutral pelvis so the correct muscles can work) then enables strong, flowing and coordinated movements.

**Alignment.** The body is a complex but closed system, and anything unbalanced within it will create problems elsewhere. A strong centre ensures the body can retain its alignment and that the correct muscles for any action are able to be engaged.
...
Very few people have a body without flaws. We all have a basic structure with inherent or created strengths and weaknesses. Stress, injury, ageing and illness all take their toll. We are, however, extremely fortunate to have minds that are able to control our bodies to such a large extent. It is thus the mind-body control aspect of Pilates that makes it so exciting and special — it opens a whole new and largely untapped world to so many of us: **body integrity**.

The Pilates method is suitable for all ages and fitness levels. Many people find it helps with:

{{< checklist title="May help with" >}}

- Injury rehabilitation
- Back, hip and other injuries
- Pre- and post-natal programmes
- Tension and headaches
- Postural problems, kyphosis / lordosis
- Those who dislike or cannot do aerobic-type exercise
{{< /checklist >}}

It is a gentle but effective method, and is recommended by many osteopaths, chiropractors and physiotherapists. Many clients also find it supports mood, quality of life, mindfulness and a positive mindset.

{{< disclaimer >}}
Pilates supports your well-being, but is not a substitute for medical care. If you have a diagnosed condition, please consult your doctor first.
{{< /disclaimer >}}
